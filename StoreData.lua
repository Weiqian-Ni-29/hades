...
BrokerData = 
{
	...
	{ 
		...
		CostName = "GiftPoints", CostAmount = -5, 
		Priority = true,
	...
	{ 
		...
		CostName = "SuperGems", CostAmount = -5, 
		Priority = true,
	...
	{ 
		...
		CostName = "SuperGiftPoints", CostAmount = -5, 
		Priority = true, 
	...
	{ 
		...
		CostName = "MetaPoints", CostAmount = -5, 
		PurchaseSound = "/SFX/KeyPickup",
	},
	...
	{ 
		...
		CostName = "SuperLockKeys", CostAmount = -5, 
		PurchaseSound = "/SFX/GemPickup",
		GameStateRequirements = { RequiredKills = { Harpy = 1 }, },
	},
